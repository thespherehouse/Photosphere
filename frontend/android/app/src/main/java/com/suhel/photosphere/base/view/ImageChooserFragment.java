...
public abstract class ImageChooserFragment<A extends BaseActivity, V extends ViewDataBinding, P, C extends BaseSubcomponent>
        extends BaseFragment<A, V, P, C> {
    ...
    private EasyImage.Callbacks easyImageCallback = new EasyImage.Callbacks() {
        ...
        public void onCanceled(EasyImage.ImageSource source, int type) {
            if (source == EasyImage.ImageSource.CAMERA) {
                File lastKnownFile = EasyImage.lastlyTakenButCanceledPhoto(getContext());
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        EasyImage.handleActivityResult(requestCode, resultCode, data, getActivity(), easyImageCallback);
    }
