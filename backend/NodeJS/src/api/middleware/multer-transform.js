...
function staticPassthroughStream() {
...
function collect(storage, req, file, cb) {
    parallel([
        ...
        storage.getExtractMetadata.bind(storage, req, file),
        ...
        storage.getContentType(req, file, function (err, contentType, replacementStream) {
            ...
            cb.call(storage, null, {
                ...
                extractMetadata: values[5],
                shouldTransform: values[6],
...
function S3Storage(opts) {
    ...
    switch (typeof opts.extractMetadata) {
        case 'function': this.getExtractMetadata = opts.extractMetadata; break
        case 'undefined': this.getExtractMetadata = staticPassthroughStream(); break
        default: throw new TypeError('Expected opts.extractMetadata to be function')
    }
...
S3Storage.prototype.transformUpload = function (opts, req, file, cb) {
    ...
    const extracted = (opts.replacementStream || file.stream).pipe(storage.getExtractMetadata(req, file))
